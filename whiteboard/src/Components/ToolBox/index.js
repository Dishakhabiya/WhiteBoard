...
import {TOOL_ITEMS,COLORS, FILL_TOOL_TYPES, STROKE_TOOL_TYPES,SIZE_TOOL_TYPES}  from "../../constants"; 
  ...
  return (
    ...
    {STROKE_TOOL_TYPES.includes(activeToolItem) && <div className={classes.selectOptionContainer}>
       ...
       { FILL_TOOL_TYPES.includes(activeToolItem) && <div className={classes.selectOptionContainer}>
            ...
            <div className={classes.toolBoxLabel}>{activeToolItem===TOOL_ITEMS.TEXT? "Text Size" :"Brush Size"}</div>
            <input type="range"
