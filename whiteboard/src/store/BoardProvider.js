...
import { createRoughElement,getSvgPathFromStroke, isPointNearElement } from "../Components/utils/element";
...
const boardReducer = (state,action) => {
    switch(action.type){
      ...
      case BOARD_ACTIONS.DRAW_DOWN:
        ...
        return {
          ...state,
            toolActionType:state.activeToolItem===TOOL_ITEMS.TEXT ?TOOL_ACTION_TYPE.WRITING: TOOL_ACTION_TYPE.DRAWING,
...
const BoardProvider = ({children}) => {
      ...
      const boardMouseDownHandler = (event,toolboxState) => {
        ...
        dispatchBoardAction({type:BOARD_ACTIONS.DRAW_DOWN,payload:{
          clientX,clientY,
      ...
      if(boardState.toolActionType===TOOL_ACTION_TYPE.DRAWING){
        dispatchBoardAction({type:BOARD_ACTIONS.DRAW_MOVE,payload:{
          clientX,clientY,
        }});
       ...
       const boardMouseUpHandler = () => {
        ...
        dispatchBoardAction({type:BOARD_ACTIONS.CHANGE_ACTION_TYPE,payload:{
          toolActionType: TOOL_ACTION_TYPE.NONE,
        }})
      };
